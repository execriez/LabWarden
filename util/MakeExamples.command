...
GLB_nf_SetPlistProperty "${sv_ConfigFilePath}" "${sv_PropertyBase}:Config:Proxy:0:Process:0" "/usr/sbin/ocspd"
...
GLB_nf_SetPlistProperty "${sv_ConfigFilePath}" "${sv_PropertyBase}:Config:Proxy:1:Process:0" "/usr/sbin/ocspd"
